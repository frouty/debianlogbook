...
Par défaut la connection ssh se fait avec un mot de passe. Cette méthode d'authentification n'est pas la plus sure.
Il est conseillé de se connecter en utilisant l'authentification par échange de clefs.
...
La clef publique est copiée dans le fichier ~/.ssh/authorized_keys sur le serveur distant
